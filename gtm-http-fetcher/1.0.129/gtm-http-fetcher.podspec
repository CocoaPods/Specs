Pod::Spec.new do |s|
  ...
  s.author       = { "Shay Erlichmen" => "erlichmen@gmail.com" }
  s.source       = {    
  ...
  s.exclude_files = 'Source/GTMHTTPFetcherLogViewController.{h,m}'

  s.ios.source_files = 'Source/GTMHTTPFetcherLogViewController.{h,m}'
