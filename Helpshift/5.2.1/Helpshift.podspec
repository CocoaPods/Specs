Pod::Spec.new do |s|
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.2.1-support/libSupport.a', 'helpshift-sdk-ios-v5.2.1-support/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.2.1-support/HSThemes/*.plist'
