Pod::Spec.new do |s|
  s.name                = 'Helpshift'
  s.version             = '5.3.0-supportBitcode'
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.3.0-support/libSupport-bitcode.a', 'helpshift-sdk-ios-v5.3.0-support/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.3.0-support/HSThemes/*.plist', 'helpshift-sdk-ios-v5.3.0-support/HelpshiftAssetCatalog.xcassets'
