Pod::Spec.new do |s|
  ...
  s.preserve_paths      = 'helpshift-sdk-ios-v5.3.0-support/libSupport.a', 'helpshift-sdk-ios-v5.3.0-support/HSLocalization/*.lproj', 'helpshift-sdk-ios-v5.3.0-support/HSThemes/*.plist', 'helpshift-sdk-ios-v5.3.0-support/HelpshiftAssetCatalog.xcassets'
