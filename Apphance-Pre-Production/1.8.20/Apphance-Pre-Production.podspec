Pod::Spec.new do |s|
  ...
  s.name         = "Apphance-Pre-Production"
  s.version      = "1.8.20"
  s.summary      = "Apphance SDK meant for pre production releases."
  s.description  = <<-DESC
...
' }
  ...
  s.source       = { :http => "http://9e6f20098e1cec83802e-e9adfe4ef715bbdac913d72a769f6b89.r69.cf1.rackcdn.com/Apphance-iOS.ARMv7s-Pre-Production-1.8.20.zip" }
  s.frameworks = 'QuartzCore', 'AudioToolbox', 'CoreLocation', 'SystemConfiguration', 'Security', 'AssetsLibrary', 'CoreTelephony'
  s.xcconfig = { 'GCC_PREPROCESSOR_DEFINITIONS' => 'APH_ENABLED=1 APH_PRE_PRODUCTION=1' }
  s.preserve_paths = 'Apphance-Pre-Production.framework'
