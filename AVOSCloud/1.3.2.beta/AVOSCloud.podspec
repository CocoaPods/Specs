Pod::Spec.new do |s|
  ...
  s.source_files   = 'iOS/release-v1.3.2.beta/AVOSCloud.framework/Versions/A/Headers/*'
  s.preserve_paths = 'iOS/release-v1.3.2.beta/AVOSCloud.framework/*'
  ...
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/AVOSCloud/iOS/release-v1.3.2.beta/"', 'OTHER_LDFLAGS' => '-ObjC -all_load' }
  s.requires_arc   = true
end
