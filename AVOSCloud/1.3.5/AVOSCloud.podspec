Pod::Spec.new do |s|
  ...
  s.source_files   = 'iOS/release-v1.3.5/AVOSCloud.framework/Versions/A/Headers/*'
  s.preserve_paths = 'iOS/release-v1.3.5/AVOSCloud.framework/*'
  ...
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/AVOSCloud/iOS/release-v1.3.5/"', 'OTHER_LDFLAGS' => '-ObjC -all_load' }
  s.requires_arc   = true
end
