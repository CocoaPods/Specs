Pod::Spec.new do |s|
  ...
  s.version      = '1.0.2'
  s.license      = 'Apache2.0'
  s.summary      = 'A spring-like dependency injection container for objective-c. Light-weight, yet full-featured.'
  s.homepage     = 'https://github.com/jasperblues/spring-objective-c'
  s.author       = { 'Jasper Blues' => 'jasper@appsquick.ly' }
  s.source       = { :git => 'https://github.com/jasperblues/spring-objective-c.git', :tag => '1.0.2' }
