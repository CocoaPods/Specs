Pod::Spec.new do |s|
  ...
  s.preserve_paths = "cblite_ios_1.0-38/*.framework", "cblite_ios_1.0-38/LICENSE.txt"
  s.vendored_frameworks = "cblite_ios_1.0-38/CouchbaseLite.framework", "cblite_ios_1.0-38/CouchbaseLiteListener.framework"
