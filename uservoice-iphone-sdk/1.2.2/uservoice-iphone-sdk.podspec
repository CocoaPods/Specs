Pod::Spec.new do |s|
  ...
  s.version      = "1.2.2"
  s.summary      = "SDK for including the UserVoice feedback system into iPhone applications."
  ...
  s.author       = 'UserVoice'
  s.source       = { :git => "https://github.com/uservoice/uservoice-iphone-sdk.git", :tag => "1.2.2" }
