...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of SimpleRemoteObject
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Hal Seki" => "hal@plants-web.jp", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Hal Seki', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "http://github.com/halsk/SimpleRemoteObject.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/SimpleRemoteObject/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/SimpleRemoteObject', :revision => '1.0.0' }
  ...
  #
  s.source_files = 'SimpleRemoteObject/SimpleRemoteObject/classes/**/*.{h,m}'
