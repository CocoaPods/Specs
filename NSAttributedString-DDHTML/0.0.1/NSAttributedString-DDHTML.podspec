#
#  Be sure to run `pod spec lint NSAttributedString-DDHTML.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "dbowen" => "email@address.com", "other author" => "email@address.com" }
  # s.author       = 'dbowen', 'other author'
