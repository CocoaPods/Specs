#
#  Be sure to run `pod spec lint PNPopBottomMsg.podspec' to ensure this is a
...
A pop bottom tip view of PNPopBottomMsg.And you do not worry the width and height of the pop tip view.
  ...
  # Or just: s.author    = "liupanniu"
  # s.authors            = { "liupanniu" => "panniuliu@139.com" }
  # s.social_media_url   = "http://twitter.com/liupanniu"
