Pod::Spec.new do |s|
  ...
  s.source			      	= { :git => "https://github.com/Simperium/simperium-ios.git", :tag => "v0.6.4" }

  s.platform 				= :osx, '10.8'
  s.osx.deployment_target	= '10.8'

  s.source_files 			= 'Simperium/*.{h,m}', 'External/SPReachability/*', 'Simperium-OSX/**/*.{h,m}'
  s.exclude_files 			= 'Simperium/SPAuthenticationViewController.{h,m}', 'Simperium/SPTOSViewController.{h,m}', 'Simperium/SPAuthenticationButton.{h,m}'
