Pod::Spec.new do |s|
  ...
  s.description  = 'A fork of the original UIDevice-Hardware (0.1.3), adding a helper method to check if the device is performant enough to support blur effects.'
