Pod::Spec.new do |s|
  ...
  s.license = { :type => 'APACHE', :file => 'apigee-ios-sdk-2.0.10/LICENSE.txt' }
  ...
  s.vendored_frameworks = 'apigee-ios-sdk-2.0.10/lib/ApigeeiOSSDK.framework' 
  s.preserve_paths = 'apigee-ios-sdk-2.0.10/lib/ApigeeiOSSDK.framework'
  s.public_header_files = 'apigee-ios-sdk-2.0.10/lib/ApigeeiOSSDK.framework/Versions/A/Headers/*.h'
