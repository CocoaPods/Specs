...
LICENSE
  ...
  s.source_files = 'GoogleAdMobAdsSdkiOS-6.4.2/*.h'
  s.preserve_paths = 'GoogleAdMobAdsSdkiOS-6.4.2'

  s.framework = %w{AudioToolbox MessageUI SystemConfiguration CoreGraphics AdSupport}
  s.library = 'GoogleAdMobAds'
  s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/Google-AdMob-Ads-SDK/GoogleAdMobAdsSdkiOS-6.4.2"' }
end
