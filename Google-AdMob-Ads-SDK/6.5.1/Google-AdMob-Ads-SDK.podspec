...
LICENSE
  ...
  s.source_files = 'GoogleAdMobAdsSdkiOS-6.5.1/*.h', 'GoogleAdMobAdsSdkiOS-6.5.1/Add-ons/Search/*.h', 'GoogleAdMobAdsSdkiOS-6.5.1/Add-ons/Mediation/*.h', 'GoogleAdMobAdsSdkiOS-6.5.1/Add-ons/DoubleClick/*.h'
  s.preserve_paths = 'GoogleAdMobAdsSdkiOS-6.5.1'

  s.framework = %w{AudioToolbox MessageUI SystemConfiguration CoreGraphics AdSupport StoreKit}
  s.library = 'GoogleAdMobAds'
  s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/Google-AdMob-Ads-SDK/GoogleAdMobAdsSdkiOS-6.5.1"' }
end
