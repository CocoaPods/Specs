Pod::Spec.new do |s|
  s.name         = "SitecoreSDKJavaScriptFramework"
  s.version      = "2.0"
...
The JavaScriptAPI that enable developers to rapidly develop applications utilising their existing IOS or web development skill sets.
...
LICENSE
  ...
  s.source       = { :http => "https://github.com/Sitecore/sitecore-ios-sdk/releases/download/v2.0/SitecoreMobileJavaScript.framework.zip" }
