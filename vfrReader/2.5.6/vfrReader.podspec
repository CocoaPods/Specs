#
# Be sure to run `pod spec lint vfrReader.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  s.version  = '2.5.6'
  s.license  = 'MIT' 
  s.summary  = 'An open source PDF file reader/viewr for iOS'
  s.homepage = 'http://www.vfr.org/'
  s.author   = { 'Julius Oklamcak' => 'unknown@mail.com' }

  # Specify the location from where the source should be retreived.
  #
  s.source   = { :git => 'https://github.com/vfr/Reader.git' }
  # s.source   = { :svn => 'http://EXAMPLE/vfrReader/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/vfrReader', :revision => '1.0.0' }

  #s.description = 'An optional longer description of vfrReader.'
