Pod::Spec.new do |s|
  ...
  s.license      =  { :type => 'Copyright', :text => 'Copyright (c) 2013 Max Goedjen. All rights reserved.' }
  s.author       = { "Max Goedjen" => "max.goedjen@gmail.com" }
  s.source       = { :git => "https://github.com/maxgoedjen/Shakedown.git", :commit => "c60b6b6df1bb0fdb459dc97a2a1b5454d232db64" }
  s.platform     = :ios, '5.0'
  s.source_files = '*.{h,m}'
