Pod::Spec.new do |s|
  ...
  s.version  = '0.0.1'
  s.license  = 'BSD'
  s.summary  = 'Simple Objective-C block-based concurrent multiple-URL data downloader based only on NSURLConnection.'
  ...
  s.clean_paths   = 'BDMultiDownloader/', 'BDMultiDownloader.xcodeproj/',  '.git/', '.gitignore'
  s.requires_arc = true
end
