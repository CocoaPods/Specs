...
For more details on how to use these features read the [Kinvey Service Overview](http://docs.kinvey.com/service-overview.html).
 ...
 contents is a violation of applicable laws.
  ...
  s.source       = { :http => "http://download.kinvey.com/iOS/KinveyKit-1.26.9.zip" }
  s.platform     = :ios
  s.ios.deployment_target = '6.0'
  s.source_files = 'KinveyKit-1.26.9/KinveyKit.framework/Versions/A/Headers/*.h'
  s.preserve_paths = 'KinveyKit-1.26.9/*.framework'
  s.vendored_frameworks = 'KinveyKit-1.26.9/*.framework'
