#
#  Be sure to run `pod spec lint TBCacaoIOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Tae Won Ha" => "qvacua@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Tae Won Ha', 'other author'
