...
LICENSE
  ...
  s.subspec 'pjsip' do |pjsip|
    pjsip.public_header_files = 'pjproject-2.2/pjsip/include/**'
    pjsip.preserve_paths      = 'pjproject-2.2/pjsip/include/**/*.h', 'pjproject-2.2/pjsip/lib/*.a'
  ...
  s.subspec 'pjlib' do |pjlib|
    pjlib.public_header_files = 'pjproject-2.2/pjlib/include/**'
    pjlib.preserve_paths      = 'pjproject-2.2/pjlib/include/**/*.h', 'pjproject-2.2/pjlib/lib/*.a'
  ...
  s.subspec 'pjlib_util' do |pjlib_util|
    pjlib_util.public_header_files = 'pjproject-2.2/pjlib-util/include/**'
    pjlib_util.preserve_paths      = 'pjproject-2.2/pjlib-util/include/**/*.h', 'pjproject-2.2/pjlib-util/lib/*.a'
  ...
  s.subspec 'pjnath' do |pjnath|
    pjnath.public_header_files = 'pjproject-2.2/pjnath/include/**'
    pjnath.preserve_paths      = 'pjproject-2.2/pjnath/include/**/*.h', 'pjproject-2.2/pjnath/lib/*.a'
  ...
  s.subspec 'pjmedia' do |pjmedia|
    pjmedia.public_header_files = 'pjproject-2.2/pjmedia/include/**'
    pjmedia.preserve_paths      = 'pjproject-2.2/pjmedia/include/**/*.h', 'pjproject-2.2/pjmedia/lib/*.a'
  ...
  s.subspec 'third_party' do |third_party|
    third_party.preserve_paths      = 'pjproject-2.2/third_party/lib/*.a'
  ...
  s.header_mappings_dir = 'pjproject-2.2'
