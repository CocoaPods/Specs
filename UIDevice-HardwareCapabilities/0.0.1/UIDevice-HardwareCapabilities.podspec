Pod::Spec.new do |s|
  s.name         = 'UIDevice-HardwareCapabilities'
  s.version      = '0.0.1'
  s.license      = { :type => 'BSD' }
  s.platform     = :ios
  ...
  s.description  = 'A fork of the original UIDevice-Hardware (0.1.3), adding helper methods to check the capabilities of a device.'
  ...
  s.source       = { :git => 'https://github.com/arkuana/UIDevice-HardwareCapabilities.git', :tag => s.version.to_s }
  s.source_files = 'UIDevice-HardwareCapabilities.{h,m}'
  s.requires_arc = true
end
