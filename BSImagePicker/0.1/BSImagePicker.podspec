#
#  Be sure to run `pod spec lint BSImagePicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Joakim Gyllstrom"
  # s.authors            = { "Joakim Gyllstrom" => "joakim@backslashed.se" }
  # s.social_media_url   = "http://twitter.com/Joakim Gyllstrom"
