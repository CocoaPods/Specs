Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "5.0"
  s.public_header_files = "NewRelic_iOS_Agent_1.309/NewRelicAgent.framework/Headers/NewRelicAgent.h"
  s.preserve_paths = "NewRelic_iOS_Agent_1.309/NewRelicAgent.framework"
