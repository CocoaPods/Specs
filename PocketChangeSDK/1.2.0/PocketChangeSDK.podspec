Pod::Spec.new do |s|
  ...
  s.source   = { :http => 'https://github.com/pocketchange/pocketchange-ios-sdk/archive/v1.2.0.zip' }
  s.platform = :ios
  ...
  s.xcconfig  =  { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/PocketChangeSDK/pocketchange-ios-sdk-1.2.0/PocketChangeSDK"' }
end
