Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/greenappleball/AdColony-iOS-SDK.git', :tag => '2.2.4' }
  ...
  s.xcconfig       =  { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/AdColony-iOS-SDK"' }
end