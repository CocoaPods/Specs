Pod::Spec.new do |s|
  ...
  s.screenshots  = "https://raw.github.com/iDay/WeixinActivity/master/ios6.png", "https://raw.github.com/iDay/WeixinActivity/master/ios7.png"

  s.platform     = :ios, '6.0'

  s.source       = { :git => "https://github.com/iDay/WeixinActivity.git", :tag => "1.0.1" }
