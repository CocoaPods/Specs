...
Pod::Spec.new do |s|
  ...
  s.version  = '1.0.0'
  s.license  = 'MIT'
  s.summary  = 'Allows you to use a UILabel with NSAttributedStrings.'
  s.homepage = 'https://github.com/AliSoftware/OHAttributedLabel'
  s.author   = { 'AliSoftware ' => 'olivier.halligon+ae@gmail.com' }

  # Specify the location from where the source should be retreived.
  #
  s.source   = { :git => 'https://github.com/AliSoftware/OHAttributedLabel.git', :tag => '1.0.0' }
  # s.source   = { :svn => 'http://EXAMPLE/OHAttributedLabel/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/OHAttributedLabel', :revision => '1.0.0' }

  s.description = 'Allows you to use a UILabel with NSAttributedStrings.'
