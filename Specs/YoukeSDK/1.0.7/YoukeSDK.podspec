Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/jxd001/YoukeSDK.git", :tag => '1.0.7' }
  s.platform     = :ios, '7.0'
  s.requires_arc = true
  ...
  s.resources = 'YoukeSDK/YoukeBundle.bundle', 'YoukeSDK/skin.plist', 'YoukeSDK/strings.plist', 'YoukeSDK/*.{xcdatamodeld,xcdatamodel}'
end
