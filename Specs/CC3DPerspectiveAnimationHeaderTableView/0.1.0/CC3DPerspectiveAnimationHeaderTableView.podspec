#
#  Be sure to run `pod spec lint CC3DPerspectiveAnimationHeaderTableView.podspec' to ensure this is a
...
CC3DPerspectiveAnimationHeaderTableView is a UITableView which implemented 3D perspective animation header.
  ...
  # Or just: s.author    = "SHIGETA Takuji"
  # s.authors            = { "SHIGETA Takuji" => "shigeta@qnote.co.jp" }
  s.social_media_url   = "https://twitter.com/caesar_cat"
