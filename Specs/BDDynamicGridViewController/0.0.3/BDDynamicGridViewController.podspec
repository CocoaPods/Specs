Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/norsez/BDDynamicGridViewController.git', :tag => '0.0.3' }
  s.description = 'Data-aware view-controller that displays a UIView list in an animated automated/customized laid out grid.'
  s.platform = :ios
