Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/antoniocasero/ACPScrollMenu.git", :tag => '1.1.0' }
  s.platform     = :ios, '5.0'
  s.resources    = 'ACPScrollMenu/ACPScrollMenu/*.{xib}'
  s.source_files = 'ACPScrollMenu/ACPScrollMenu/*.{h,m}'
