Pod::Spec.new do |s|
  ...
  s.author            = { 'Adam McCarthy' => 'adam@intercom.io', 'Gavin Rooney' => "gavin@intercom.io", "Dale Cantwell" => "dale@intercom.io", "Ignacio Delgado" => "ignacio@intercom.io", "Roland Gröpmair" => "roland@intercom.io" }
