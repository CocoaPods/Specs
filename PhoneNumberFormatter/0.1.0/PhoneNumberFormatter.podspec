#
# Be sure to run `pod spec lint PhoneNumberFormatter.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.source   = { :svn => 'http://EXAMPLE/PhoneNumberFormatter/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/PhoneNumberFormatter', :revision => '1.0.0' }

  s.description = 'An optional longer description of PhoneNumberFormatter.'
