#
#  Be sure to run `pod spec lint ACETelPrompt.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/acerbetti/ACETelPrompt.git", :tag => "1.0.0" }
  ...
  s.source_files  = "ACETelPrompt/*.{h,m}"
