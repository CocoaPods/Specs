Pod::Spec.new do |s|
  ...
  s.version  = '0.4.1'
  s.license  = 'MIT'
  s.summary  = 'JBTabBarController aims to be a drop-in replacement for UITabBarController with the '   \
  ...
  s.source   = { :git => 'https://github.com/jinthagerman/JBTabBarController.git', :tag => '0.4.1' }
  s.platform = :ios
