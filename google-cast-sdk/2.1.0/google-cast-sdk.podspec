...
sender APIs to enable your iOS app to send content to a large display.
  ...
  s.author = 'Google, Inc.'
  s.source = { :http => 'https://developers.google.com/cast/downloads/GoogleCastFramework-2.1.0-Release.zip' }
  s.platform = :ios, '6.0'
  s.source_files = 'GoogleCastFramework-2.1.0-Release/GoogleCast.framework/Versions/A/Headers/*.h'
