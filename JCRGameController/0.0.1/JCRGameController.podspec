#
#  Be sure to run `pod spec lint JCRGameController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "César Pinto Castillo"
  # s.authors            = { "César Pinto Castillo" => "cesar@jagcesar.se" }
