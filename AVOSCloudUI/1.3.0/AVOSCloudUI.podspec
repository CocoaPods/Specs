Pod::Spec.new do |s|
  ...
  s.source         = { :git => "https://github.com/avos/avoscloud-sdk.git" , :tag => '1.3.0'}
  s.source_files   = 'iOS/release-v1.3.0/AVOSCloudUI.framework/Versions/A/Headers/*'
  s.preserve_paths = 'iOS/release-v1.3.0/AVOSCloudUI.framework/*'
  ...
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/AVOSCloudUI/iOS/release-v1.3.0/"' }
  s.requires_arc   = true
end
