Pod::Spec.new do |s|
  ...
  s.source_files   = 'iOS/release-v1.3.3/AVOSCloudUI.framework/Versions/A/Headers/*'
  s.preserve_paths = 'iOS/release-v1.3.3/AVOSCloudUI.framework/*'
  ...
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/AVOSCloudUI/iOS/release-v1.3.3/"' }
  s.requires_arc   = true
  s.libraries = 'icucore'
end
