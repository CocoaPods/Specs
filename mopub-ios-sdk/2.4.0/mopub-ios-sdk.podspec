Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "5.0"
  s.source       = { :git => "https://github.com/mopub/mopub-ios-sdk.git", :tag => "2.4.0" }
  ...
  s.subspec 'MoPubSDK' do |ss|
    ...
    ss.dependency 'mopub-ios-sdk/MoPubSDK_Internal'
    ss.dependency 'mopub-ios-sdk/Native_Ads'
  end

  s.subspec 'MoPubSDK_Internal' do |ss|
    ss.source_files = 'MoPubSDK/Internal/**/*.{h,m}'
    ss.dependency 'mopub-ios-sdk/MoPubSDK'
  end

  s.subspec 'Native_Ads' do |ss|
    ss.source_files = 'MoPubSDK/Native Ads/*.{h,m}'
    ss.dependency 'mopub-ios-sdk/MoPubSDK'
    ss.dependency 'mopub-ios-sdk/Native_Ads_Internal'
  end

  s.subspec 'Native_Ads_Internal' do |ss|
