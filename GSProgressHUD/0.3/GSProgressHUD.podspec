Pod::Spec.new do |s|
  ...
  s.version      = "0.3"
  s.summary      = "GSProgressHUD is a simple progress HUD for displaying information to the user."
  ...
  s.platform     = :ios, '5.0'
  s.source       = { :git => "https://github.com/GaSaMedia/GSProgressHUD.git", :tag => "0.3" }
