#
# Be sure to run `pod spec lint SEDraggable.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  #
  s.source   = { :git => 'http://github.com/brynbellomy/SEDraggable.git', :tag => '1.0.0' }

  # s.description = 'An optional longer description of SEDraggable.'
