Pod::Spec.new do |s|
  ...
  s.subspec 'MemoryStorage' do |ss|
    ...
    ss.source_files = 'DTModelStorage/Memory', 'DTModelStorage/Utilities/DTModelSearching.h', 'DTMemoryStorage+UpdateWithoutAnimations.h','DTMemoryStorage+UpdateWithoutAnimations.m'
  end
