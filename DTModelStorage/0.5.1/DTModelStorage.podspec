Pod::Spec.new do |s|
  ...
  s.subspec 'MemoryStorage' do |ss|
    ...
    ss.source_files = 'DTModelStorage/Memory', 'DTModelStorage/Utilities/DTModelSearching.h', 'DTModelStorage/Utilities/DTMemoryStorage+UpdateWithoutAnimations.{h,m}'
  end
