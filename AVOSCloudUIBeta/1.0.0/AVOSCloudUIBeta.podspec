Pod::Spec.new do |s|
  ...
  s.source         = { :git => "https://github.com/avos/avoscloud-sdk.git", :tag => "beta" }
  ...
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/AVOSCloudUI/iOS/beta/"', 'OTHER_LDFLAGS' => '-ObjC -all_load' }
  s.requires_arc   = true
end
