Pod::Spec.new do |s|
  ...
  s.preserve_paths = 'adlibrTestUniversal/adlibrTestUniversal/ads/lib'

  s.library   = 'Adlibr.3.2'

  s.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(PODS_ROOT)/adlibr/adlibrTestUniversal/adlibrTestUniversal/ads/lib' }
