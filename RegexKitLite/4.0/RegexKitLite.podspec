#
# Be sure to run `pod lint RegexKitLite.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.source   = { :svn => 'http://EXAMPLE/RegexKitLite/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/RegexKitLite', :revision => '1.0.0' }

  # s.description = 'An optional longer description of RegexKitLite.'
