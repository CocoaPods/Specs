Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://app.crittercism.com/images/Crittercism_v4_0_1.zip' }
  s.platform = :ios
  s.frameworks = 'SystemConfiguration'
  s.source_files = 'CrittercismSDK/*.h'
  s.preserve_paths = 'CrittercismSDK/libCrittercism_v4_0_1.a'
  s.library = 'Crittercism_v4_0_1'
