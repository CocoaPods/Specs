Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://app.crittercism.com/images/Crittercism_v4_1_2.zip' }
  s.platform = :ios
  s.source_files = 'CrittercismSDK/*.h'
  s.resource = 'CrittercismSDK/dsym_upload.sh'
  s.preserve_paths = 'CrittercismSDK/libCrittercism_v4_1_2.a'
  s.library = 'Crittercism_v4_1_2'
