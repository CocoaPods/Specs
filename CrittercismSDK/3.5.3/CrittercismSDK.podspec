Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://app.crittercism.com/images/Crittercism_v3_5_3.zip' }
  s.platform = :ios
  s.source_files = 'CrittercismSDK/*.h'
  s.preserve_paths = 'CrittercismSDK/libCrittercism_v3_5_3.a'
  s.library = 'Crittercism_v3_5_3'
