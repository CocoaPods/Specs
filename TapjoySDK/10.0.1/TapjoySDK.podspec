Pod::Spec.new do |s|
  ...
  s.source   = { :http => 'https://s3.amazonaws.com/tapjoy/sdks/TapjoySDK_iOS_v10.0.1.zip' }
  s.platform = :ios

  s.resources  = "TapjoySDK_iOS_v10.0.1/Libraries/Tapjoy.embeddedframework/**/*.bundle"

  s.public_header_files = 'TapjoySDK_iOS_v10.0.1/Libraries/Tapjoy.embeddedframework/Tapjoy.framework/**/*.h'
  s.preserve_paths = 'TapjoySDK_iOS_v10.0.1/Libraries/Tapjoy.embeddedframework/Tapjoy.framework'
  s.vendored_frameworks = 'TapjoySDK_iOS_v10.0.1/Libraries/Tapjoy.embeddedframework/Tapjoy.framework'
