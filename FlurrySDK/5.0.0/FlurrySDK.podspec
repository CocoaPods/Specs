...
Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/AntonPalich/Flurry.git',
#commit just for now until tag appears https://github.com/AntonPalich/Flurry/issues/6    
                 :commit => "4f622bca18165245151994b6be045c6be6150d53"
#                 :tag => "#{s.version}" 
                 }
