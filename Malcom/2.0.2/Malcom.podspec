Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/MyMalcom/malcom-lib-ios.git', :tag => '2.0.2' }  
  ...
  s.frameworks = 'MobileCoreServices', 'SystemConfiguration', 'MediaPlayer', 'AVFoundation', 'CFNetwork', 'MobileCoreServices', 'QuartzCore', 'CoreTelephony', 'CoreLocation', 'AudioToolbox', 'MessageUI', 'CoreGraphics', 'StoreKit', 'Security', 'AdSupport'
  s.library = 'z'
