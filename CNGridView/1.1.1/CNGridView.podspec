Pod::Spec.new do |s|
  s.name                  = 'CNGridView'
  s.version               = '1.1.1'
  s.summary               = 'CNGridView is a (wanna be) replacement for NSCollectionView. It has full delegate and dataSource support with method calls like known from NSTableView/UITableView.'
