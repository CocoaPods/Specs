Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                      ...
                      See http://monavari.de/fileadmin/data_archive/images/iOS7Menu/iOS7Menu%20-%20Breitband.m4v
                    DESC
  s.homepage     = "http://bit.ly/1cAd9WV"
  s.screenshots  = "http://monavari.de/fileadmin/data_archive/images/iOS7Menu/iOS7Menu_screen1.png"

  s.license      = { :type => 'MIT', :file => 'LICENSE.txt' }
  s.author       = { "Constantin Lebrecht" => "constantin@monavari.de" }
  s.source       = { :git => "https://github.com/hijolan/iOS7Menu.git", :tag => "0.0.3" }
