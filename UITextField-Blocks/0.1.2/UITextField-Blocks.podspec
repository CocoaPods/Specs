Pod::Spec.new do |s|
  ...
  s.version      = "0.1.2"
  s.summary      = "Adds blocks to all UITextField delegate methods with a category, no need for subclassing. Also allows the use of delegate methods if no block is set."
