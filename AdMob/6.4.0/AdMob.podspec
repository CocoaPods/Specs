...
LICENSE
  ...
  s.source_files = 'GoogleAdMobAdsSdkiOS-6.4.0/*.h'
  s.preserve_paths = 'GoogleAdMobAdsSdkiOS-6.4.0'

  s.framework = %w{AudioToolbox MessageUI SystemConfiguration CoreGraphics AdSupport}
  s.library = 'GoogleAdMobAds'
  s.xcconfig  =  { 'OTHER_LDFLAGS' => '-ObjC', 'LIBRARY_SEARCH_PATHS' => '"${PODS_ROOT}/AdMob/GoogleAdMobAdsSdkiOS-6.4.0"' }
end
