...
s.source            = { :http => "http://sdk.umsns.com/download/ios/3.3.5/8711.zip"}
...
s.public_header_files      = "umeng_ios_social_sdk_3.3.5_custom/UMSocial_Sdk_3.3.5/Header/*.h","umeng_ios_social_sdk_3.3.5_custom/UMSocial_Sdk_Extra_Frameworks/Wechat/*.h"
